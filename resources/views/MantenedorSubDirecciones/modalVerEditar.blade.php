    ...
    <div class="modal-dialog modal-md">
        <div class="modal-content">
            ...
            <div class="modal-header">
                <h5>Edición de Sub Dirección ID : {{$sub_direccion->id}}</h5>
            ...
            <div class="modal-body">
                <div class="row">
                    <div class="col-md-10 offset-md-1">
                        <form action="{{route('mantenedor_sub_direcciones.update', ['mantenedor_sub_direccione' => $sub_direccion->id])}}" method="PUT"
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <input type="text" class="form-control" name="nombre" id="nombre"
                                        value="{{$sub_direccion->nombre}}">
                                </div>

                                <div class="col-md-12 mt-4">
                                    <label for="observacion">Observación </label>
                                    <input type="text" class="form-control" name="observacion" id="observacion"
                                        value="{{$sub_direccion->observacion}}">
                                </div>
    ...
    $("#formulario_editar_direccion").submit(function (e) {
        ...
        $.ajax({
            ...
            success: function (data) {
                if (data == 'sub_direccion_actualizada') {
                    let timerInterval
                    Swal.fire({
                        icon: 'success',
                        title: 'Institución actualizada exitosamente',
